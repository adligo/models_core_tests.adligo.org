...
import org.adligo.models.core.client.Changeable;
...
import org.adligo.models.core.client.ids.SIDParamFactory;
...
public class MockModelsEntryPoint implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		try {
			...
			holder.addUsed(Changeable.class);
			holder.addUsed(new ChangeableMutant());
	...
	private void addIdClasses() {
		...
		holder.addUsed(SIDParamFactory.class);
