...
import org.adligo.models.core.client.I_SerializableAddress;
import org.adligo.models.core.client.I_SerializableNamedId;
import org.adligo.models.core.client.I_SerializableOrg;
import org.adligo.models.core.client.I_SerializablePerson;
import org.adligo.models.core.client.I_SerializablePhoneNumber;
import org.adligo.models.core.client.I_SerializableStorageIdentifier;
import org.adligo.models.core.client.I_SerializableStringIdentifier;
import org.adligo.models.core.client.I_SerializableSubject;
import org.adligo.models.core.client.I_SerializableUser;
import org.adligo.models.core.client.I_SerializableVersionedIdentifier;
...
public class MockModelsEntryPoint implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		try {
			...
			holder.addUsed(I_SerializableAddress.class);
			holder.addUsed(I_SerializableNamedId.class);
			holder.addUsed(I_SerializableOrg.class);
			holder.addUsed(I_SerializablePerson.class);
			holder.addUsed(I_SerializablePhoneNumber.class);
			holder.addUsed(I_SerializableStorageIdentifier.class);
			holder.addUsed(I_SerializableStringIdentifier.class);
			holder.addUsed(I_SerializableSubject.class);
			holder.addUsed(I_SerializableUser.class);
			holder.addUsed(I_SerializableVersionedIdentifier.class);
